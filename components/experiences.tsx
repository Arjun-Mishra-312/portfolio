...
export function Experiences() {
  return (
    <div className="p-10 grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full">
      ...
      <WobbleCard containerClassName="col-span-1 row-span-1 min-h-[300px]">
      ...
      <WobbleCard containerClassName="col-span-1 lg:col-span-2 bg-pink-800 min-h-[400px] lg:min-h-[400px] xl:min-h-[300px]">
