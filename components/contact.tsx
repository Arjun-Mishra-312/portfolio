    ...
    <div className="flex flex-col items-center justify-center h-[40rem]  ">
      ...
      <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 space-x-0 md:space-x-4 px-4">
        <Link href="/Resume.pdf">
          <button className="relative w-40  inline-flex h-12 overflow-hidden rounded-full p-[1px] bg-purple-400 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
        ...
        <Link href="https://github.com/Arjun-Mishra-312">
          <button className="relative w-40  inline-flex h-12 overflow-hidden rounded-full p-[1px] bg-gray-300 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
      ...
      <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 space-x-0 md:space-x-4 pt-4">
        <Link href="https://www.linkedin.com/in/-arjun-mishra/">
          ...
          <button className="relative w-40 inline-flex h-12 overflow-hidden rounded-full p-[1px] bg-blue-400 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
        ...
        <button className="relative w-40 inline-flex h-12 overflow-hidden rounded-full p-[1px] bg-teal-500 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
